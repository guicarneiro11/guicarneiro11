...
- 👨‍💻 Freelance em Wordpress ( PHP + MySQL) - Migração de host + ajustes no tema & banco de dados
- 👨‍💻 Estágio em programação web front-end na Alboom

## 🎓 Educação

- 🎓 Fisioterapia - Último período (Trancado)
- 🎓 Ciencia da Computação - Em breve (2026)
